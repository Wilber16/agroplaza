      ...
      if($pass != $cpass){
         ...
         if($select_user->rowCount() > 0){
            ...
            try {
               ...
               $cuerpo = 'Estimado usuario <br> Para continuar con el proceso de registro es necesario de click en el siguiente link <a href="http://localhost:8081/food%20website%20backend/home.php">Activar cuenta</a>';
