...
if(isset($_POST['submit'])){
   ...
   if($check_cart->rowCount() > 0){
      ...
      if($address == ''){
         $message[] = 'por favor agregar su direccion!';
      }else{
...
<form action="" method="post">
   ...
   <div class="user-info">
      ...
      <a href="update_address.php" class="btn">agregar direccion</a>
      ...
      <input type="submit" value="generar orden" class="btn 
      <?php 
      if($fetch_profile['address'] == ''){echo 'disabled';} 
      if ($_SERVER['REQUEST_METHOD'] === 'POST') {
         $selectedOption = $_POST['method'];
         if ($selectedOption === "cash on delivery"){
            echo "gracias";
         }elseif ($selectedOption === "paypal") {
            header("Location: http://localhost:8081/food%20website%20backend/pagoPaypal.php");
         exit();
         }
      }
